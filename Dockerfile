...
FROM php:8.1-cli-alpine as step1
...
COPY --from=step1 /usr/local/lib/php/extensions/no-debug-non-zts-20210902/imagick.so /usr/local/lib/php/extensions/no-debug-non-zts-20210902/
